...
class Omega2dSimulator(arcade.Window):
    ...
    def load_configs(self, config_file):
        ...
        # print(self.arena_mdl_lb, self.arena_mdl_ub, self.x_lb, self.x_ub)
        self.field_mdl = self.translate_sys_to_arena([9.0, 6.0, 99.0])
        # print(self.field_mdl)
    ...
    def draw_arena(self):
        ...
        # arcade.draw_ellipse_outline(self.field_mdl[0], self.field_mdl[1], 400.5, 200.5, arcade.color.BITTER_LIME, 10)
    ...
    def update(self, delta_time):
        ...
        print(self.time_elapsed, self.avg_delta)
